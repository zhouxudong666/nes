        ...
        (function ($) {
            $.fn.JSNESUI = function (roms) {
                ...
                var UI = function (nes) {
                     ...
                     */
                    if ($.offset) {
                        self.screen.touchstart(function (e) {
                            if (self.nes.mmap) {
        ...
        (function ($) {
            $.fn.JSNESUI = function (roms) {
                ...
                var UI = function (nes) {
                    ...
                    $('#controls-direction').bind('mousedown', function (e) {
                        handleDirection(e);
                        e.preventDefault();
                    })
                    $('#controls-direction').bind('gesturestart', function (e) {
                    ...
                    $('#controls-direction').bind('mouseup', function (e) {
                        $('#controls-direction .left').removeClass('active');
                        $('#controls-direction .up').removeClass('active');
                        $('#controls-direction .down').removeClass('active');
                        $('#controls-direction .right').removeClass('active');
                    ...
                    $('#joystick_btn_up').bind('mousedown', function (e) {
                        self.nes.keyboard.keyDown({
                            keyCode: 87
                        });
                        e.preventDefault();
                    ...
                    $('#joystick_btn_up').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 87
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_down').bind('mousedown', function (e) {
                        self.nes.keyboard.keyDown({
                            keyCode: 83
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_down').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 83
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_left').bind('mousedown', function (e) {
                        self.nes.keyboard.keyDown({
                            keyCode: 65
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_left').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 65
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_right').bind('mousedown', function (e) {
                        console.log("right");
                        self.nes.keyboard.keyDown({
                            keyCode: 68
                        });
                    ...
                    $('#joystick_btn_right').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 68
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_A').bind('mousedown', function (e) {
                        console.log("a");
                        self.nes.keyboard.keyDown({
                            keyCode: 74
                        });
                    ...
                    $('#joystick_btn_A').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 74
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_B').bind('mousedown', function (e) {
                        console.log("b");
                        self.nes.keyboard.keyDown({
                            keyCode: 75
                        });
                    ...
                    $('#joystick_btn_B').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 75
                        });
                        e.preventDefault();
                    });
                    $('#joystick_btn_select').bind('mousedown', function (e) {
                        self.nes.keyboard.keyDown({
                            keyCode: 17
                        });
                        $('#joystick_btn_select').addClass('active');
                    ...
                    $('#joystick_btn_select').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 17
                        });
                        $('#joystick_btn_select').removeClass('active');
                    ...
                    // start mousedown 
                    $('#joystick_btn_start').bind('mousedown', function (e) {
                        self.nes.keyboard.keyDown({
                            keyCode: 13
                        });
                        $('#joystick_btn_start').addClass('active');
                    ...
                    $('#joystick_btn_start').bind('mouseup', function (e) {
                        self.nes.keyboard.keyUp({
                            keyCode: 13
                        });
                        $('#joystick_btn_start').removeClass('active');
                    ...
                    // end mousedown
                    $('#controls-fire').bind('mousedown', function (e) {
                        handleFire(e);
                        e.preventDefault();
                    });
                    $('#controls-fire').bind('gesturestart', function (e) {
                    ...
                    $('#controls-fire').bind('mouseup', function (e) {
                        clearInterval(self.interval);
                        $('#controls-fire .a').removeClass('active');
                        $('#controls-fire .b').removeClass('active');
                        self.nes.keyboard.keyUp({
                    ...
                    $('#controls-turbofire').bind('mousedown', function (e) {
                        handleFire(e, true);
                        e.preventDefault();
                    });
                    $('#controls-turbofire').bind('gesturestart', function (e) {
                    ...
                    $('#controls-turbofire').bind('mouseup', function (e) {
                        clearInterval(self.interval);
                        $('#controls-turbofire .a').removeClass('active');
                        $('#controls-turbofire .b').removeClass('active');
                        self.nes.keyboard.keyUp({
